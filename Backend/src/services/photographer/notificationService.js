// src/services/photographer/notificationService.js
const pool = require('../../config/db');

/**
 * Fetch paginated notifications for a photographer with optional filters.
 */
async function getPhotographerNotifications({ userId, type, from, to, page = 1, limit = 10 }) {
  ...
  const subjectMap = {
    ...
    // add more photographer-specific types here if needed
  };
...
module.exports = { getPhotographerNotifications };
